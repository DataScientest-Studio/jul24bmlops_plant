...
from ..schemas.auth_schema import Token, UserBase, UserResponse, RoleResponse, RoleBase, UserCreate
from ..config import settings
from ..database.db import get_db
from ..utils.auth_utils import get_current_admin_user, get_current_user, authenticate_user, get_password_hash, create_access_token
...
async def read_admin_user(current_user: UserBase = Depends(get_current_admin_user)):
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve admin info: {str(e)}")
